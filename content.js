    ...
    cards: [
      {
        ...
        lines: {
          it: ["Check-in nelle camere dalle ore 14:00", "Castello di Rosciano", "<span class=\"detail-em\">Cena, Pizza &amp; Festa ore 18:30</span>", "Dress code: festive chic"],
          en: ["Check-in to the rooms from 2:00 PM",  "Castello di Rosciano", "<span class=\"detail-em\">Dinner, Pizza  &amp; Party at 6:30 PM</span>", "Dress code: festive chic"],
          he: ["צ'ק-אין לחדרים מ-14:00",              "קסטלו די רוסקיאנו",   "<span class=\"detail-em\"> ארוחת, פיצה ערב ומסיבה ב-18:30</span>", "קוד לבוש: שיק חגיגי"],
        },
      },
      {
        icon:  "💍",
